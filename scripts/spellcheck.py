...
WHITELIST = {
    ...
    "kvintesenciu", "kvintesencia", "kvintesencie", "kvintesencii", "kvintesenciou",
    ...
    # Common valid Slovak words LanguageTool flags incorrectly
    "svetlušky", "svetlušiek", "svetluškami",
    "glyf", "glyfy", "glyfov", "glyfom",
    "mačiek", "mačkovitá", "mačkovité",
    "ťahla", "pulzujúca", "pulzujúce", "pulzujúci",
    "tetované", "tetovaných", "tetovanými",
    "vyplazenými", "skvíkali", "namaľovanými",
    "kňažskými", "kňažskú", "kňažských",
    "bijúcu", "bijúce", "bijúci",
    "zaklopila", "dusiacu", "dusiace",
    "pasáže", "pasáží", "pasáží",
    "mantry", "mantrami",
    "zakázanosťou",
    "kože", "koži",
    "rozpadajúcimi", "bubnujúce", "bubnujúci",
    "pláži", "pláž",
    "pomyslela",
    "infera",
    "predsvitaní", "predsvitanie",
    "rejs", "rejsu", "rejsom",
    "šeda",
    "nyauský", "nyauským", "nyauského", "nyauskom",
    "litániu", "litánie",
    "hiragany", "hiragane",
    "medzipriestore",
    "dozvibrovala",
    ...
    "rennova",
    "kotvisko",
    "flintovi", "flintov", "flintom",
    "arkotovi", "arkotove", "arkotom", "arkota",
    "tamiinom",
}
