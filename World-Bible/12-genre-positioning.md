# NULL VOID — Identita Sveta

> Toto nie je marketingový dokument. Je to kompas — aby si pri rozširovaní sandboxu vedel, aký tón držíš, aká je DNA tohto sveta, a prečo táto kombinácia funguje.
...
## 2. DNA — Porovnateľné tituly

### Nausicaä of the Valley of the Wind (Miyazaki, 1984)

| Čo berieme | Čo pridávame |
|------------|-------------|
| Epický svet, ekologické témy, stará technológia omylom považovaná za prírodu | Hard sci-fi základ (nanotech JE tá „príroda"), tmavšie dôsledky, multi-POV |
| 5-dielna štruktúra (manga), filozofická hĺbka | Kastový systém, inštitucionálne násilie, morálne sivé zóny |

**Kľúčový rozdiel:** Nausicaä je fundamentálne optimistická. NULL VOID si nádej zaslúži cez utrpenie.

### The Saga of Tanya the Evil (Youjo Senki)

| Čo berieme | Čo pridávame |
|------------|-------------|
| Dieselpunk + „mágia" vo vojenskom prostredí, morálne komplexný protagonista | 3000-ročná hĺbka lore, rodina ako emocionálne jadro (nie isekai reinkarnácia) |
| WW1/WW2 estetika, taktické boje | Multi-kontinentálny svet, evolučný cyklus Wraithov, Upload dilema |

**Kľúčový rozdiel:** Tanya je jeden POV, jedna vojna. NULL VOID je multi-generačný, multi-kontinentálny.

### Fullmetal Alchemist (Arakawa)

| Čo berieme | Čo pridávame |
|------------|-------------|
| Hard „magic" s pravidlami a cenou, filozofické otázky o ľudskosti, humor + tma | Sci-fi fundament (nie alchýmia, ale nanotech), hlbšie klamstvo (postavy nevedia, že ich mágia je tech) |
| Bratský/rodinný vzťah ako jadro | Otec-dcéra tragédia, kde dcéra je antagonistka s 2750 rokmi samoty |

**Kľúčový rozdiel:** FMA je shōnen s jasným morálnym kompasom. NULL VOID je morálne šedšie — aj „hrdina" bol vojenský zabijak.

### Ďalšie DNA stopy

- **Made in Abyss** — cute postavy v horifikujúcich situáciách, worldbuilding hĺbka
- **Attack on Titan** — mystery boxy, vrstevnaté konšpirácie, grimdark tón, skryté pravdy
- **Cowboy Bebop** — melanchólia + humor, character-driven, epizodická štruktúra v rámci väčšieho oblúku
- **Ghost in the Shell** — AI/vedomie filozofia, cyberpunk estetika, identita a telo

---

## 3. Spektrum tónu (Tone Dial)

Tón v NULL VOID nie je binárny (tmavý ALEBO vtipný). Je to **spektrum**:

```
1 ──────────── 5 ──────────── 10
GRIMDARK         NEUTRÁL         ANIME HUMOR
```

### Mapovanie podľa typu scény

| Typ scény | Rozsah | Príklad |
|-----------|--------|---------|
...
- **Účel:** Ventil po napätí. Diferenciácia postáv. Kultúrny worldbuilding.
- **Typy:**
...
**Princíp:** V reálnom živote sa ľudia smejú v temných časoch. Vojaci žartujú. Utečenci sa smejú. Deti sa hrajú v ruinách. Toto je to, čo odlišuje NULL VOID od čistého grimdark (kde je všetko neúprosné) aj od čistého anime (kde sa dôsledky resetujú).

---

## 4. Sandbox filozofia

NULL VOID nie je uzavretý príbeh s definovaným koncom. Je to **živý svet** — sandbox, do ktorého sa dá vracať, rozširovať ho, pridávať nové vrstvy.
...
### What If — Alternatívne príbehy v rovnakom svete
...
Lepšie ako konzumovať podpriemerný isekai — vytvoriť si vlastný svet. NULL VOID je kreatívny priestor, ktorý rastie s autorom. Každá nová myšlienka, každý nový vplyv sa dá organicky integrovať do existujúceho lore, pretože svet je dostatočne veľký a dostatočne hlboký na to, aby absorboval čokoľvek.
