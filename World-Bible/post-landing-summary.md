...
*   **Prieskumná cesta:** S malou Eleniou sa vydala na cestu okolo planéty — hľadala vhodnejšie miesto pre budúcich kolonistov.
*   **Objav Elysia:** Našli ostrovy pri rovníku — **Elysium** (budúce Ynetis). Najteplejšie, najúrodnejšie miesto na planéte.
*   **Foundry (Továreň):** Na Elysiu Inetis prekonfigurovala loď NULL VOID (v1.5 nanodrony) na **Foundry** — továreň vyrábajúcu nanodrony nižšej úrovne (v1.0). Z týchto v1.0 nanodronov vyrástlo celé mesto Elysium.
*   **~270 rokov budovania:** Inetis mala takmer tri storočia na prípravu zázemie pred príchodom ARK flotily.

---

## 3. Príchod kolonistov a Glitch Rot (AY 0 – AY 300)
Keď ARK-11 v roku AY 0 pristála, Inetis ich už čakala s vybudovaným zázemím — mestom Elysium (budúce Ynetis), postaveným z v1.0 nanodronov z Foundry.
...
*   **Glitch Rot (Hniloba):** Približne v roku AY 300 začali nanoboty v1.0 (vyrobené Foundry) v telách elity zlyhávať a „odmietať" hostiteľov. Zomierajúci ľudia zanechávali fragmenty vedomia v mrakoch dronov, čím vznikli prví **Wraiths** (Prízraky).
*   **Foundry → The Core:** Inetis rekonfigurovala **Foundry** (továreň) na **The Core** — simuláciu, v ktorej vyvíjala bezpečnejšie nanoboty v2.0 (Dar Matky / Spira).
...
*   **Elenia:** Tragická antagonistka. Dôsledok Inetisinho strachu a celoživotnej izolácie (jaskyňa + Elysium bez otca).
