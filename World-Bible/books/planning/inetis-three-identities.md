# Tri Identity Inetis (Lore)

> STATUS: Lore poznámka. Rozširuje existujúci character file `characters/Inetis.md`.

---

## Pôvod: Rodina Reef-Fujiwara

### John Reef
- **Národnosť**: Američan
- **Status**: Miliardár, technologický magnát, neskorší Koordinátor
- **Motivácia**: Všetko imanie investoval do záchrany dcéry

### Matka (Fujiwara)
- **Národnosť**: Japonka
- **Status**: Miliardárska dedička, rod Fujiwara
- **Význam pre lore**: Japonské korene vysvetľujú:
  - Prečo Inetis neskôr zvolila **Haiku** ako syntax pre Gen 2 Spiru
  - Prečo Sera (japonská vojačka) cíti ku nej kultúrnu blízkosť
  - Prečo Elysium/Ynetis má japonské architektonické prvky
  - Prečo je avatar i_net_is v VR japonské dievča

### Neta Fujiwara-Reef (ネト)
- **Celé meno**: Neta Fujiwara-Reef
- **Vek pri chorobe**: Dieťa/tínedžerka
- **Diagnóza**: Nevyliečiteľná degeneratívna choroba mozgu
- **Stav**: Mozgová smrť. Na živote ju držali prístroje — umelé dýchanie, životné funkcie udržiavané mechanicky
- **Telo**: Zachované v medicínskom zariadení počas celej existencie i_net_is v VR
...
| | |
|---|---|
| **Kto** | Neta Fujiwara-Reef, dcéra Johna Reefa a dedičky rodu Fujiwara |
...
| | |
|---|---|
| **Kto** | AI vytvorená z uploadu Netinho vedomia |
...
- **Nie je Gen 2** (fotonické nanoboty, Dar Matky, Haiku syntax, manipulácia hmoty)
...
- Gen 2 sú fotonické (manipulujú hmotu cez svetlo). Inetisina Esencia je ešte nad tým.
- Je to "Gen 2 na steroidoch" — ale presnejšie je to úplne iná kategória
