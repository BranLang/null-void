...
**Key Events:**
- Maks + Tami prichádzajú do Šoravenu
- Úplatok dockarom (500 zlatých)
- Tami reveals identity (líščie uši)
- Maks/Tami conflict dialogue

**Lore Notes:**
- Maks = superzrak vďaka nanotechu (nie slepý!)
...
- **Tamina motivácia (REV):** Flint mŕtvy (zabitý pri zatýkaní, telo verejne vystavené ako varovanie), Arkot a Yera ŽIVÍ v kobkách niekoľko mesiacov. Tami VIE o zrade (ukradli Anténu), ale príde ich zachrániť — stále sú jej rodina. Motivácia = záchrana + artefakt.
...
- Kito identifikuje Maksa ako Štvrtý Príchod
- Maks ukazuje Black Dust Eyes
...
**Character Knowledge States:**
- **Maks:** Vie, že artefakt je pod Chrámom. Nevedel o legende "Spáč". Použil Starorečou ako psychologickú zbraň.
- **Tami:** Skeptická voči proroctvám. Videla Maxove oči z Prachu (nie prvýkrát). Efektívna pri intel-gathering.
- **Kito:** Identifikoval Maksa ako Spáča. Zúfalý — Maya zomiera. Rozhodol sa ísť s nimi.
...
- Tunely pod Šoravenom (atmosférický crawl, Maks zachráni Kita)
...
- **Útek z tunelov:** Dramatická evakuácia, Maks stráca samopal M4A1 (prasknutý popruh), Tami stráca pištoľ (voda vytrhla z puzdra), Kito stráca okuliare
...
### Sera Character:
- **Species:** 100% Human, native Japanese, geneticky upravená (ARK-11)
- **Age:** ~3200 rokov (biologicky 20)
- **Gen 1 + Gen 2 nanoboty** (vampirizmus = no glitch rot)
- **Posledný živý človek zo Zeme**, posledný čo videl Japonsko
...
- Sera = bodyguard Elanie (sľub Inetis: "Daj pozor na moju dcéru")
- **Seberovná** s Elaniou (rovnako silná, lepšia vo väčšine vecí)
- **ALE:** Nemá ambície vládnuť - CHCE slúžiť (voľba, nie podriadenosť)
- **Why?** Elania = jediná vec, čo ju stále prekvapuje po 3000 rokoch
  - Elania = kreatívna, ADHD, depresie striedajú šialené nápady
...
- Severania (Maks, Tami, Kito) **nerozumejú** — zachytia len tvary slov, ktoré kedysi mohli byť angličtinou
...
- **Maks:** Stráca samopal M4A1 + 3 zásobníky nanodronovej munície (popruh praskol v tuneli)
...
### Fight Choreography:
- **Duration:** ~15 sekúnd
- **Strategy:** Maks + Tami = distraction, Sera = finisher
- **First Ape:** Sera strikes from behind, Yari through neck
- **Second Ape:** Enraged attack, Sera dodges, spine strike
- **Ego flex:** Kicks helmet off dead Ape, "Hlúpe opice"

### Post-Fight:
- Sera analyzes Maks's nanodrony technique during fight
- Admits: "Proti tebe... pravdepodobne by som prehrala"
- Maks recognizes her as best Gen 2 programmer on planet
...
- Maks bez samopalu — používa pušky z mŕtvych, šetrí Prach
- **Maks prevezme velenie** nad ustupujúcimi obrancami (seržant Bran)
...
- **Cena:** 32% nanobotov sa nevráti (trvale). Maks v kritickom stave (4h bez návratu = smrť)
- Grawská armáda stratí hlavu — batéria stíchne, pechota bez rozkazov

**Lore Notes:**
- Blood Ritual = maximálna eskalácia. Maks to robí len keď niet inej možnosti.
- Nanoboty opúšťajú telo cez póry — krv + strieborná hmota, tisíce mikroskopických rán
- Oči sa zrieďujú (Čierny Prach odchádza) → Maks takmer oslepne počas rituálu
- Grond = Generál, nie vojak. Velí z bezpečnej vzdialenosti (6 km). Maks to rešpektuje.
...
**Character Knowledge States:**
- **Maks:** Velenie = jeho element. Ale vie, že pušky nestačia. Blood Ritual = posledná možnosť.
- **Obrancovia:** Nevedia, čo Maks urobil. Len vedia, že Graw sa zastavil. Grondova smrť je záhada.
- **Grawská armáda:** Grond zomrel "z ničoho nič" — žiadne vysvetlenie, žiadny nepriateľ
- **Nikto:** Maks sa nikdy nepriznal. Nie je jasné ani *že* Gronda niekto zabil — mohol to byť infarkt, jed, kliatba. Záhada zostáva záhadou.
- **Maksova krv po rituáli:** Obrancovia videli zakrvaveného Maksa a mysleli si, že ho zasiahli šrapnely a sklo z bombardovania. Dokonalé krytie — nemusel klamať, len mlčať.
...
**Key Events:**
- Maks padá do snehu, na hranici smrti
- Flashback vízie (Inetis, ARK ship, Grondov duch)
- Nanoboty vyčerpané, telo kolabuje
- Tami ho nájde, zúfalá
- Maks: "Anténa... ochráň Anténu" — Tami: "Kašlať na Anténu!"

**Lore Notes:**
- Paralela s prebudením z AY 3000 (obe scény v snehu)
- **Archive material:** `archive/prologue-1-draft-kael-samaell.md` obsahuje Kael/Samaell duel + Maks-v-klietke scénu, ktorá patrí do flashbacku tohto chapter
...
- Maks, Tami a Links nastupujú na Druhú Šancu (Kapitánka Vex)
...
- Kito tells story of Maks & Tami — **NIE eyewitness bitky, ale civilista v zóne**
...
**What Maks DOESN'T know:**
- ❌ Čo sa stalo s Inetis
- ❌ Kde je NULL VOID (loď)
- ❌ Kde je jeho kryobox
- ❌ Či Inetis prežila pád
- ❌ Kde Inetis skončila
- ❌ Čo sa stalo posledných 3000 rokov

**What Maks DOES know:**
- ✅ Zobudil sa slepý v polokóme (AY 3000)
- ✅ Ubehlo 3000 rokov
- ✅ Je na neznámej planéte (Terre)
- ✅ **ŽIADNE info o Inetis za 13 rokov**
- ✅ **Hľadá stopy** - preto ide po Anténe

**When Maks meets Sera:**
- Prvý človek s Gen 1+2 nanobotmi (13 rokov)
- Prvý človek s perfektnou japončinou
- Prvý človek ovládajúci Haiku na úrovni Inetis
- **= PRVÁ MOŽNÁ STOPA K NULL VOID/INETIS**

**Maks's Question to Sera:**
- **NOT:** "Si to ty, Inetis?" (vie 100% že Sera NIEJE Inetis)
- **NOT:** "Žije Inetis?" (nemá dôvod dúfať že žije)
- **YES:** "Poznala si Netu Fujiwara? Vieš čo sa s ňou stalo? Vieš kde je NULL VOID?"
- **Motivation:** Desperate for ANY INFORMATION (first lead in 13 years)

**Sera's Response Impact:**
- "Poznala som ju" (past tense)
- **NOT:** Death confirmation (Maks nevedel či vôbec žila)
- **YES:** Incomplete information → FRUSTRÁCIA
- Sera VIE, ale nepovie mu (not her place)

**Maks's Emotional Arc:**
- Desperate search → First lead → Incomplete answer → Frustration → Promise of future truth
...
**Maks:**
- Vie 100% že Sera NIEJE Inetis (úplne iné tváre, postavy)
- Ale Sera BY MOHLA BYŤ Vševedúca Matka (legendy o Gen 2, japončina)
- Prvá stopa k Inetis/NULL VOID za 13 rokov
- Frustrovaný že nevie viac
...
### Elementálna Štruktúra (5 kníh):
- **Kniha 1: PRACH (Achilla)** = Hmota, fyzická realita, telo, prežitie
- **Kniha 2: OHEŇ** = Energia, transformácia, deštrukcia (Earth flashback)
- **Kniha 3: VODA** = Čas, tok, pamäť (Inetis POV)
- **Kniha 4: VZDUCH** = Priestor, sloboda, spojenie (Maks + Elania)
- **Kniha 5: KVINTESENCIA** = Transcendencia, VR finále v Core

---

## Character Arcs (Book 1):
...
**Tami:**
- Start: Partner, skeptik, flexuje na Maksa
- Chapter 2: Rutinne zabíja Experimenty s Maksom
- Chapter 3: Vidí niekoho silnejšieho (Sera), uncanny valley
- Arc: Confident → Humbled → Realizes world is bigger

**Kito:**
- Start: Nervous knihovník
- Chapter 2: Prežije boj, pomáha telekinézou
- Chapter 3: Religiózna skúsenosť (bohyňa Sera)
- Arc: Academic → Witness → Believer
...
- Arc: Observer → Participant → Messenger

---

## Future Setup:

**Three Towers Prophecy:**
- First tower: [TBD]
- Second tower: [TBD]
- Third tower: **Věž Stratených** (Elania's domain, južný kontinent)
- Final meeting: Maks + Sera + Elania (Book 4)
- Full truth revealed: [Elania = Maks's daughter]

**Elania Cliffhanger (End of Book 1):**
```
Maks stál pri soche. Studený kameň. Fialové oči.

„Neto," zašepkal. „Prepáč. Za všetko."

A potom — bzučanie. V hlave. Nanoboty zachytili signál.

Hlas v jeho hlave — ženský, studený, mechanický:

"Generál Maksimilian. Toto je Operátor E-07. Konfirmujem: Ste nažive."

Maks nedýchal.

"Pripájam vás k sieti. Vitajte späť... otec."
...
**When writing Sera:**
- Show age through exhaustion in eyes, not exposition
- Uncanny valley effect: "príliš dokonalá", nie len krásna
- Voice switches mid-conversation (unsettling but effective)
- Pragmatizmus: žiadne zbytočné slová
- Japanese heritage: občas Japanese words (Yari, Haiku, curses like "Ishtar no yarou")
- NOT Mary Sue: Specialized vs Apes, weak vs Maks's nanodrony
- Serves Elania by CHOICE: no ambition to lead, but wants to be near someone INTERESTING

**When writing Maks:**
- Superzrak (nanoboty), nie slepý
- 13 rokov hľadá info o Inetis/NULL VOID - ŽIADNE odpovede
- Prvýkrát za 13 rokov cíti strach (Paladíni)
- Frustrovaný incomplete info (Sera), nie devastovaný
- Show veteran experience: analyzuje, plánuje, efektívny
- Felix legacy: japonské maniere, Haiku basics, combat training
...
- Ch5 Krvavý Rituál: KOMPLETNÝ REWRITE (126 → 366 riadkov)
  ...
  - Maks bez samopalu — používa pušky z mŕtvych, šetrí Prach
  - Maks prevezme velenie (seržant Bran, Tretia hradba, 60 vs 800)
...
- Ch3 critical audit — 9 issues found and fixed:
  ...
  - Fixed: Maks fear arc (strach patrí len do Ch3 Paladíni, nie Ch2)
...
- Equipment losses: Maks (samopal M4A1), Tami (pištoľ), Kito (okuliare)
...
- Ch2 revision — porovnanie s Ch1, opravy:
  - Fixed: Maks "Investori" → odstrániť (neladí s vojenským hlasom)
  ...
  - Fixed: Maks internal monologue (príliš self-aware → Asistent readout)
...
- Added: Sera character file
- Added: Chapter 3 (Sera vs Paladíni fight)
- Updated: Maks knowledge state (no false hope about Inetis)
- Added: This CHAPTER-NOTES.md file
...
- [ ] Integrovať Maks-v-klietke + baby-Tami scénu z archive do Ch7 flashbacku
