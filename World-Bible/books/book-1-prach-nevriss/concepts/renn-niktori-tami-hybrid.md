...
- **100% Vulpini** (líščí rod)
- **Spira sa dedí po matke** — preto má Tami líščiu Spiru
- **Zomrela keď mala Tami 1 rok** — Tami si ju nepamätá

### Ako zomrela:
- Renn trpel **Glitch Rot / Bit Rot** — jeho Gen 1 nanoboty degradovali bez údržby
- Tamina matka (Varietas so Spirou) sa mu **dobrovoľne ponúkla** — mohol z nej po troche vysávať Spiru a obnovovať si nanoboty
- **Láska ako liek** — ona mu dávala kúsok seba, aby žil. Vedome, dobrovoľne.
- **Jedného dňa to prehnal.** Vysál príliš veľa. Došlo ku tragédii.
- Renn ju zabil. Nie úmyselne — ale výsledok je rovnaký.
- Tami mala **1 rok**. Nepamätá si nič.

### Dôsledky pre Renna:
- Zabil ženu, ktorú miloval — vlastnými rukami, kvôli vlastnej slabosti
- **Prestal praktizovať vampirizmus navždy** — radšej degradoval a umrel pomaly, než aby riskoval znova
- Preto bol taký slabý, keď ho piráti zabili — vedome sa nechal zomierať
- **Tami sa nikdy nedozvie pravdu** — Renn jej nestihol povedať, a Felix (ak vie) to drží v sebe
- Renn žil posledných 6 rokov s vinou — hľadač pokladov, ktorý utiekol od všetkého
...
| Dedičstvo | Zdroj | Čo má |
|---|---|---|
| **Spira (líščia)** | Po matke (Vulpini) | Aktívna, v krvi — Pursang schopnosti |
| **Modré oči** | Po otcovi (človek zo Zeme) | Ľudský marker — nezvyčajné medzi líškami |
| **"Čistejší" vzhľad** | Ľudská krv | Vyzerá inak ako bežný Pursang — jemnejšie rysy, niečo neuchopiteľné |
| **Gen 1 nanoboty** | **NIE** | Gen 1 sa nededia, nedajú sa transferovať |
| **Gen 1.7** | **NIE (zatiaľ)** | Môže získať neskôr cez Anténu — ale nie dedičnosťou |

### Čo Tami NEMÁ (dôležité):
- Žiadne Gen 1 nanoboty po otcovi — nededia sa
- Žiadne spiace nanoboty v privesku — nič také
- Nie je "vyvolená" — je jednoducho hybrid

### Čo Tami JE:
- Dôkaz, že ľudia a Varietas môžu žiť spolu
- Dieťa dvoch svetov — Zeme a Achillu
- Jej dualita nie je kliatba — je prísľub novej éry

---

## Dôsledky pre príbeh

### Prečo vyzerá "čistejšie" ako Pursang:
- Ľudská krv zjemňuje Varietas rysy
- Modré oči = okamžite viditeľný marker
- Ľudia, čo ju stretnú, cítia, že je *iná* — nevedia prečo
...
## Tematická paralela: Starý svet vs Nový svet
...
- **Links** = čistý človek (žiadne nanoboty, žiadna Spira, len mozog) — miluje Varietas dievča
- **Spolu** = symbol novej éry, kde rozdelenie medzi ľuďmi a Varietas stráca zmysel
